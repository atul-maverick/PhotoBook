...
@route('/modules/authentication/services.js',method="GET")
def send():
    output =static_file('services.js',root="modules/authentication/")
    return output
	
@route('/modules/home/controllers.js',method="GET")
def send():
    output =static_file('controllers.js',root="modules/home/")
    return output
...
@route('/modules/authentication/controllers.js',method="GET")
def send():
    output =static_file('controllers.js',root="modules/authentication/")
    return output

@route('/modules/authentication/views/login.html',method="GET")
def send():
